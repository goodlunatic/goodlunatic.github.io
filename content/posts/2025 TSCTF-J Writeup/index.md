---
title: 2025 TSCTF-J Writeup
subtitle:
date: 2025-10-10T10:28:49+08:00
slug: 443835e
draft: false
author:
  name: Lunatic
...
通过社工找到出题人的博客，点击`新生常见问题解答`这篇文章，可以发现招新赛跳转的链接是有问题的
...
可以定位到具体的仓库，最后在 URL 中的 commit 后跟上这个 hash 值即可得到最后的 flag：`TSCTF-J{‌‌‌‌‍﻿‍‍‌‌‌‌‍‍﻿﻿‌‌‌‌‍‬‌‍‌‌‌‌‍‬﻿‬‌‌‌‌‍﻿‌﻿‌‌‌‌‍﻿‍﻿‌‌‌‌‍‬‍‍‌‌‌‌‍﻿‌‬‌‌‌‌‍‍﻿﻿‌‌‌‌‍‬‬‌‌‌‌‌‍‬‍‍‌‌‌‌‍﻿‌‬‌‌‌‌‍‬‍‍u_answer_here}`
