...
去网上搜一个伏羲八卦图，然后按照上面的这个顺序把二维码拼接一下，可以得到下图
...
![](imgs/image-20250305100412272.png)

拼完后尝试扫码，但是发现是乱码

![](imgs/image-20250305101308007.png)
