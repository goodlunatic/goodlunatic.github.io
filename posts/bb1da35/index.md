...
![](./imgs/image-20260113200153729.png)



![](./imgs/image-20260113200137359.png)

可以人眼去找，也可以写脚本或者直接WPS图片转文字

![](./imgs/image-20260113200347902.png)
...
附件给了一张JPG图片，010打开，发现JPG里藏了一段`Quote-Printable编码`，看特征猜测解码后是个zip

![](imgs/image-20260401095035710.png)
...
enc_bytes = b'''PK=03=04=14=00=00=00=08=00Vo=C7V>k=16u=16=00=00=00=14=00=00=00=08=00=00=00h=
...
dec_bytes = quopri.decodestring(enc_bytes)
print(dec_bytes)
with open('out.zip', "wb") as f:
    f.write(dec_bytes)
```

运行以上脚本后可以得到一个zip，经过尝试发现是伪加密，用010修改加密位后解压

可以得到一个加密的zip和一个hint.txt，内容如下

> hint:do_u_like_xxx

很明显提示了掩码攻击

![](imgs/image-20260401095356490.png)

设置好掩码后爆破可以得到解压密码：`do_u_like_ftc`，解压zip后即可得到最后的flag：

`flag{2dd1fb86e06912797d39cbddd42f2da3}`
