...
**一开始写这篇博客的想法是记录一下群友们问的一些的Misc题**

**但是随着问题的师傅们越来越多，无奈本人的精力有限，这篇博客的容量也有限**

**因此打算后续师傅们问的题以及对应的 Writeup 都搬到我的 [知识星球](https://t.zsxq.com/an6p6) 上**

**同时我也邀请了一些实力强劲的 Misc 师傅作为星球的嘉宾一起看看题，具体嘉宾列表可以扫码查看**
...
这里的 key 不知道怎么和密文结合起来，尝试直接爆破 XOR 的密钥，可以得到密钥是：`0327>`

![](imgs/image-20251105221149151.png)

`flag{e80a347393293a9aa21055843b676163}`
