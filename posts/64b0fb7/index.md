...
> 一些题外话：
> 
> 如果想要测试的WiFi是CMCC、ChinaNet、CU开头的话，捕获的包是光猫包，这个的密码一般都比较复杂
> 
> 如果本地算力或者字典资源欠缺的话，也可以到某平台上找代跑，关键词搜 `WPA代跑`、`握手包代跑` 即可
> 
> 一般的`WPA/WPA2`握手包代跑大概在 ¥5-¥8 左右，光猫包的话就更贵一点，大概在 ¥40-¥80+
